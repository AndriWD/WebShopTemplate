...
namespace NewWebShopStream.Service
{
    public class AdminAreaAuthorizathion : IControllerModelConvention
    {
        private readonly string area;
        private readonly string policy;
        public AdminAreaAuthorizathion(string area, string policy)
        {
            this.area = area;
            this.policy = policy;
        }
